...
abstract class DBHelper {
  ...
  static Future<void> init() async {
    ...
    try {
      ...
      String _path = p.join(databasePath, 'flutter_sqlflite.db');
  ...
  static void onCreate(Database db, int version) async {
    String sqlQuery =
        'CREATE TABLE products(id INTEGER PRIMARY KEY AUTOINCREMENT, productName STRING, CategoryId INTEGER, productDesc STRING, productPrice REAL, productPic STRING)';
